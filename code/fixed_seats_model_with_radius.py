...
def fixed_seats_model_with_radius(data_file, seat_radius, d0, d1 = 0, d2 = 0, d3 = 0, firstrow: bool = False, firstrow_y = 0.0, type=1, num_selection = 10, output_filename_affix='output'):
    '''
...
if __name__ == "__main__":
    # change the path here on your own computers!!! the excel file can be found in examples directory
    # input file should have three columns: Feature, X, Y
    data_file = "input/example_all_coordinates.xlsx"
    ...
    # d2 = 216
    # d3 = 81
    # fixed_seats_model(data_file, d0=12 * 12, d2=d2, d3=d3, firstrow=firstrow, firstrow_y=firstrowy,
    #                   type=1, output_filename_affix='12ft_prevention')
    ...
    fixed_seats_model_with_radius(data_file, seat_radius=12, d0=6 * 12)
